...
//wikipedia
builder.Services.AddHttpClient<IWikipediaSearchService, WikipediaSearchService>();
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1.01/swagger.json", "NemoFind v1.01"));
}
